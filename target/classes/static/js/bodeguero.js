...
function mostrarPedidos(lista) {
    ...
    lista.forEach(pedido => {
        ...
        `).join('') : '<li style="padding: 1rem; background: linear-gradient(135deg, #f0fdf4 0%, #ecfeff 100%); border-radius: 16px; display: flex; align-items: center; gap: 12px; border: 1px solid #bbf7d0;"><span style="font-size: 1.8rem;">📄</span><div><div style="font-weight: 700; color: #166534; font-size: 1rem;">¡Descarga el PDF!</div><div style="color: #15803d; font-size: 0.875rem; margin-top: 2px;">Abre el PDF para ver el detalle completo de los productos</div></div></li>';
